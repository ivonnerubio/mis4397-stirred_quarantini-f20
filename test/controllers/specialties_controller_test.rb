...
class SpecialtiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create specialty" do
    assert_difference('Specialty.count') do
      post specialties_url, params: { specialty: { category_description: @specialty.category_description, category_title: @specialty.category_title, string: @specialty.string, string: @specialty.string, text: @specialty.text, title: @specialty.title } }
    end
  ...
  test "should update specialty" do
    patch specialty_url(@specialty), params: { specialty: { category_description: @specialty.category_description, category_title: @specialty.category_title, string: @specialty.string, string: @specialty.string, text: @specialty.text, title: @specialty.title } }
